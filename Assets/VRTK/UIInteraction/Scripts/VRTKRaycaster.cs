...
public class VRTKRaycaster : GraphicRaycaster, IPointerEnterHandler
{
	...
	protected override void Start()
	{
		if(!canvas.worldCamera)
		{
			...
			canvas.worldCamera = Camera.main;//rig.centerEyeAnchor.gameObject.GetComponent<Camera>();
		}
	}
    ...
    /// <summary>
    /// Performs a raycast using the pointer object attached to this VRTKRaycaster
    /// </summary>
    /// <param name="eventData"></param>
    /// <param name="resultAppendList"></param>
